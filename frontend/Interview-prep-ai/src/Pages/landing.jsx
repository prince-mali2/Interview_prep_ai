...
const landing = () => {
  ...
  return (
    ...
    <div className='w-full min-h-full bg-[#FFFCEF]'>
      <div className=' bg-amber-200/20 blur-[65px] absolute top-0 left-0'/>

        <div className='container max-auto px-4 pt-6 pb-[200px] relative z-10 lg:ml-30'>
        {/* Header */}
        ...
        <div className='flex flex-col md:flex-row items-center'>
          <div className='w-full md:w-1/2 pr-4 mb-8 md:mb-0'>
            <div className='flex items-center justify-left mb-2'>
              <div className='flex items-center gap-2 text-[13px] text-amber-600 font font-semibold bg-amber 100 px-3 py-1 rounded-full border  border-amber-300'>
          ...
          <div className='w-full md:w-1/2'>
            ...
            <button 
            className='bg-black text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-[#FFFCEF] hover:text-black border border-yellow-50 hover:border-yellow-300 transition-colors cursor-pointer'
            onClick={handleCTA}
            >
              Get Started
            </button>
    ...
    {/* Now Showing the features Cards */}
    <div className="w-full min-h-full bg-[#FFFCEF] mt-10" >
      <div className="container mx-auto px-4 pt-10 pb-20">
        <section className="mt-5">
          <h2 className="flex text-2xl font-semibold justify-center items-center my-15">
